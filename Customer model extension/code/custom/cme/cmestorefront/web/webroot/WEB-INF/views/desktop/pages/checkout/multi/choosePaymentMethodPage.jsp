		...
		<div class="span-18 checkout_multi_b first">
			<div class="item_container_holder">
				...
				<div class="item_container">
					<div class="item_container">
						<p class="left"><spring:theme code="checkout.multi.paymentMethod.savedCards.selectSavedCardOrEnterNew"/></p>
			...
			<c:if test="${not empty selectedPaymentMethodId}">
				<ycommerce:testId code="choosePaymentMethod_continue_link">
					<a href="${checkoutSummaryUrl}" class="positive right pad_right">
