...
import com.epam.cme.storefront.controllers.cms.ProductFeatureComponentController;
    ...
    public void testRenderComponent() throws Exception {
        ...
        given(
                productFacade.getProductForOptions(productModel,
                        Arrays.asList(ProductOption.BASIC, ProductOption.PRICE, ProductOption.SUMMARY))).willReturn(
                productData);
