...
/**
 * Stripped out org.apache.tomcat.util.http.ServerCookie for use of #appendCookieValue(StringBuffer,
 * int, String, String, String, String, String, int, boolean, boolean)
 */
public class ServerCookie implements Serializable {
    ...
    public static void appendCookieValue(final StringBuffer headerBuf, int version, final String name,
            final String value, final String path, final String domain, final String comment, final int maxAge,
        ...
        if (maxAge >= 0) {
            ...
            if (version == 0) {
                ...
                if (maxAge == 0) {
                    ...
                    OLD_COOKIE_FORMAT.format(new Date(System.currentTimeMillis() + maxAge * 1000L), buf,
                            new FieldPosition(0));
                }
            }
        }
