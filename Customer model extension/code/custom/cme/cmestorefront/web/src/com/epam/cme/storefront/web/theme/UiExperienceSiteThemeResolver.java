...
/**
 * Resolve the spring theme name from the CMSSite. The spring theme name is built from the CMSSite
 * UID and the CMSSite Theme.
 */
public class UiExperienceSiteThemeResolver extends AbstractThemeResolver {
    ...
    protected String determineDefaultThemeName() {
        ...
        if (currentSite != null) {
            return combineSiteAndTheme(uiExperienceLevel.getCode(), currentSite.getUid(),
                    getThemeNameForSite(currentSite));
        }
        return null;
    }
