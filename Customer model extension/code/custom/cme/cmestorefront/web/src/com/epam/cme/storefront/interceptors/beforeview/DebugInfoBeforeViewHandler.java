...
/**
 * BeforeViewHandler that adds additional debug information to the request attributes so that these
 * can be output into the page to help with development or production issues.
 * 
