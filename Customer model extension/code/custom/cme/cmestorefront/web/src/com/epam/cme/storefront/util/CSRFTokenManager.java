...
/**
 * A manager for the CSRF token for a given session. The {@link #getTokenForSession(HttpSession)}
 * should used to obtain the token value for the current session (and this should be the only way to
