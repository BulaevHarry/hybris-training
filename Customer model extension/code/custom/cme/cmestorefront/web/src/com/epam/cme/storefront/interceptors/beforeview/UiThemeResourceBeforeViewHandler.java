...
import com.epam.cme.storefront.util.CSRFTokenManager;
...
/**
 * Interceptor to setup the paths to the UI resource paths in the model before passing it to the
 * view.
 * 
 * Sets up the path to the web accessible UI resources for the following: * The current site * The
 * current theme * The common resources
 * 
...
public class UiThemeResourceBeforeViewHandler implements BeforeViewHandler {
    ...
    public void beforeView(final HttpServletRequest request, final HttpServletResponse response,
        ...
        final List<String> dependantAddOns = requiredAddOnsNameProvider.getAddOns(request.getSession()
