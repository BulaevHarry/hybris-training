...
public class StoreBreadcrumbBuilder {
    ...
    public List<Breadcrumb> getBreadcrumbsForSubPage(final PointOfServiceData pointOfServiceData,
            final String pageResourceKey) throws IllegalArgumentException {
        final List<Breadcrumb> breadcrumbs = new ArrayList<Breadcrumb>();
        ...
        final String pageLinkName = getMessageSource().getMessage(pageResourceKey, null,
                getI18nService().getCurrentLocale());
