...
/**
 * Default Controller for CMS Component. This controller is used for all CMS components that don't
...
public class DefaultCMSComponentController extends AbstractCMSComponentController<SimpleCMSComponentModel> {
    ...
    protected void fillModel(final HttpServletRequest request, final Model model,
            final SimpleCMSComponentModel component) {
        // See documentation for CMSComponentService.getEditorProperties, but this will return all
        // frontend
