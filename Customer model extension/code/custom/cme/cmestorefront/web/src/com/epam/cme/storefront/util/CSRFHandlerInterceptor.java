...
/**
 * A Spring MVC <code>HandlerInterceptor</code> which is responsible to enforce CSRF token validity
 * on incoming posts requests. The interceptor should be registered with Spring MVC servlet using
