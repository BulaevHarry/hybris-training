...
public class StorefrontResourceBundleSource implements ThemeSource, ResourceLoaderAware, MessageSource {
    ...
    public Theme getTheme(final String themeName) {
        ...
        synchronized (this.themeCache) {
            ...
            final MessageSource themeUiExperienceMessageSource = createMessageSource(themeBasename + "-"
                    + uiExperienceCode, addOnThemeMessageSource);
            ...
            final MessageSource siteUiExperienceMessageSource = createMessageSource(siteBasename + "-"
                    + uiExperienceCode, addOnSiteMessageSource);
    ...
    protected MessageSource createAddOnMessageSource(final List<String> addOnNames,
            final MessageSource parentMessageSource, final String... nameParts) {
