...
public class AcceleratorAddOnFilter extends GenericFilterBean {
    ...
    public class PlainResourceAddOnResolver extends ResourceAddOnResolver {
        ...
        protected String[] getAddOnExtensionInfo() {
            return patternMatcher.group(EXTENSION_INFO_GROUP).split("/", 2); // first from whole
                                                                             // request path
        }
    ...
    public class ExecutableResourceAddOnResolver extends ResourceAddOnResolver {
        ...
        @Override
        protected String[] getAddOnExtensionInfo() {
            final String resourcePath = patternMatcher.group(EXTENSION_INFO_GROUP); // first from
                                                                                    // whole request
                                                                                    // path
    ...
    /**
     * Copies file @param sourceAddOnFileName to @param targetWebAddOnFileName if it is older.
