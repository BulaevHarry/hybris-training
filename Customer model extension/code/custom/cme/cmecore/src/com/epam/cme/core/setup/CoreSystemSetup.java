...
public class CoreSystemSetup extends AbstractSystemSetup
{
	...
	protected void importProductCatalog(final SystemSetupContext context, final String catalogName, final boolean sync)
	{
		...
		// add types BundleTemplate and BundleTemplateStatus as root types to the ProductCatalog synchronization job
	...
	private void createAndActivateSolrIndex(final SystemSetupContext context, final String catalogName)
	{
		...
		importImpexFile(context, "/cmecore/import/productCatalogs/" + catalogName + "ProductCatalog/solr.impex",
				false);

		createSolrIndexerCronJobs(catalogName + "Index");

		importImpexFile(context, "/cmecore/import/productCatalogs/" + catalogName
				+ "ProductCatalog/solrtrigger.impex");
