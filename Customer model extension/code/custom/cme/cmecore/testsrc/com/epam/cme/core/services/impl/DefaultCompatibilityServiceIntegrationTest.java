...
public class DefaultCompatibilityServiceIntegrationTest extends ServicelayerTest {
    ...
    public void testFindVendorCompatibleAccessories() {
        ...
        final List<ProductModel> vcAccessories = compatibilityService.getAccessoriesForVendorCompatibility("109058",
                "Accessory");
    ...
    public void testShouldFindFeatureCompatibleAccessoriesOfDiffVendor() {
        ...
        assertCompatibileListIsCorrect(fcAccessories,
                Sets.newHashSet("109059", "Accessory1", "Accessory4", "Accessory5"));
