...
public class CmeCustomerDetailsEditWidgetRenderer extends CustomerDetailsEditWidgetRenderer {
    ...
    private boolean isUserCsAdmin() {
        final UserModel currentUser = userService.getCurrentUser();
        final UserGroupModel csAdminGroup = userService.getUserGroupForUID("csadmingroup");
        return userService.isMemberOfGroup(currentUser, csAdminGroup);
    }
