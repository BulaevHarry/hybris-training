...
public class InitialDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		...
		// importStoreInitialData(context, "cmeinitialdata", "yaccelerator", "yaccelerator", Collections.singletonList("yaccelerator"));
		if (getBooleanSystemSetupParameter(context, IMPORT_SAMPLE_DATA))
		{
			...
			importStoreInitialData(context, SAMPLE_DATA_IMPORT_FOLDER, "telco", "telco", Collections.singletonList("telco"));
	...
	protected void importProductCatalog(final SystemSetupContext context, final String importDirectory, final String catalogName)
	{
		...
		importImpexFile(context, "/telcoacceleratorsampledata/import/productCatalogs/telcoProductCatalog/bundletemplates.impex");
		importImpexFile(context, "/telcoacceleratorsampledata/import/productCatalogs/telcoProductCatalog/bundletemplates_en.impex");
		...
		importImpexFile(context,
				"/telcoacceleratorsampledata/import/productCatalogs/telcoProductCatalog/bundletemplates-pricerules.impex", true, true);
		importImpexFile(context,
