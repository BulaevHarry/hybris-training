...
public class PlanBundleTabsPopulatorIntegrationTest extends ServicelayerTest {
    ...
    public void setUp() throws Exception {
        ...
        LOG.info("Finished data for PlanBundleTabsPopulatorIntegrationTest." + (System.currentTimeMillis() - startTime)
                + "ms");
    ...
    public void testPopulate() throws CommerceCartModificationException {
        ...
        // freqTab1: 1 year
        checkTabAndPlanData(bundleTabData.getFrequencyTabs(), "SMART_STANDARD_1Y",
                TermOfServiceFrequency.ANNUALLY.getCode(), 1, Double.valueOf(40), false, false);
        // freqTab2: 2 years
        checkTabAndPlanData(bundleTabData.getFrequencyTabs(), "SMART_STANDARD_2Y",
                TermOfServiceFrequency.ANNUALLY.getCode(), 2, Double.valueOf(35), false, false);
        // freqTab3: 3 years
        checkTabAndPlanData(bundleTabData.getFrequencyTabs(), "SMART_STANDARD_3Y",
                TermOfServiceFrequency.ANNUALLY.getCode(), 3, Double.valueOf(30), false, false);
        // freqTab4: 12 months
        ...
        checkTabAndPlanData(bundleTabData.getFrequencyTabs(), "SMART_ADVANCED_2000_12M",
                TermOfServiceFrequency.MONTHLY.getCode(), 12, Double.valueOf(60), true, false);
        checkTabAndPlanData(bundleTabData.getFrequencyTabs(), "SMART_ADVANCED_5000_12M",
                TermOfServiceFrequency.MONTHLY.getCode(), 12, Double.valueOf(70), true, false);
        checkTabAndPlanData(bundleTabData.getFrequencyTabs(), "SMART_ADVANCED_NOLIM_12M",
                TermOfServiceFrequency.MONTHLY.getCode(), 12, Double.valueOf(80), true, false);
        // freqTab5: 24 months
        checkTabAndPlanData(bundleTabData.getFrequencyTabs(), "SMART_ADVANCED_1000_24M",
                TermOfServiceFrequency.MONTHLY.getCode(), 24, Double.valueOf(50), false, false);
        checkTabAndPlanData(bundleTabData.getFrequencyTabs(), "SMART_ADVANCED_2000_24M",
                TermOfServiceFrequency.MONTHLY.getCode(), 24, Double.valueOf(60), false, false);
        checkTabAndPlanData(bundleTabData.getFrequencyTabs(), "SMART_ADVANCED_5000_24M",
                TermOfServiceFrequency.MONTHLY.getCode(), 24, Double.valueOf(70), false, false);
        checkTabAndPlanData(bundleTabData.getFrequencyTabs(), "SMART_ADVANCED_NOLIM_24M",
                TermOfServiceFrequency.MONTHLY.getCode(), 24, Double.valueOf(80), false, false);
        // freqTab6: 36 months
        checkTabAndPlanData(bundleTabData.getFrequencyTabs(), "SMART_ADVANCED_1000_36M",
                TermOfServiceFrequency.MONTHLY.getCode(), 36, Double.valueOf(50), false, false);
        checkTabAndPlanData(bundleTabData.getFrequencyTabs(), "SMART_ADVANCED_2000_36M",
                TermOfServiceFrequency.MONTHLY.getCode(), 36, Double.valueOf(60), false, false);
        checkTabAndPlanData(bundleTabData.getFrequencyTabs(), "SMART_ADVANCED_5000_36M",
                TermOfServiceFrequency.MONTHLY.getCode(), 36, Double.valueOf(70), false, false);
        checkTabAndPlanData(bundleTabData.getFrequencyTabs(), "SMART_ADVANCED_NOLIM_36M",
                TermOfServiceFrequency.MONTHLY.getCode(), 36, Double.valueOf(80), false, false);
    }

    private void checkTabAndPlanData(final List<FrequencyTabData> freqTabData, final String planCode,
            final String freqCode, final int serviceTermNo, final Double expPrice, final boolean expIsTabPreselected,
            final boolean expIsPlanPreselected) {
        int planCounter = 0;
            ...
            if (freqCode.equals(freqTab.getTermOfServiceFrequency().getCode())
                ...
                for (final ProductData plan : freqTab.getProducts()) {
                    if (planCode.equals(plan.getCode())) {
                        ...
                        // expPrice, Double.valueOf(plan.getPrice().getValue().doubleValue()));
