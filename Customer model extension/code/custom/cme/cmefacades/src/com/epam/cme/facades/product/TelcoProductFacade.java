...
/**
 * Telco product facade that provides functionality to return products that a) are 1 to 1 product
 * references and feature compatible products b) are 1 to 1 product references and feature and
 * vendor compatible products
 */
public interface TelcoProductFacade extends ProductFacade {

    /**
     * Get unique list of product references and feature compatible products with a max limit set by
     * maximunNumber Of Products First list of product references is returned and then feature
     * compatible products are returned
     * 
     * @param code
    ...
    /**
     * Get unique list of product references ,feature compatible and vendor compatible products with
     * a max limit set by maximunNumber Of Products First list of product references is returned and
     * then feature compatible products and then vendor compatible products are returned
     * 
     * @param code
     * @param referenceTypes
     *            {@link List} of {@link ProductReferenceTypeEnum}s
