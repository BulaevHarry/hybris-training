...
import com.epam.cme.hmc.constants.CmehmcConstants;



/**
 * This is the extension manager of the Cmehmc extension.
 */
public class CmehmcManager extends GeneratedCmehmcManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(CmehmcManager.class.getName());
	 ...
	 */
	public static CmehmcManager getInstance()
	{
		return (CmehmcManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				CmehmcConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CmehmcManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CmehmcManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of CmehmcManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of CmehmcManager called, current tenant: " + getTenant().getTenantID());
		}
	}
